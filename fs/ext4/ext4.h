...
#define EXT4_GET_BLOCKS_CONVERT_UNWRITTEN	0x0200
	/* Put anchor on extents */
#define EXT4_GET_BLOCKS_PUT_HOT_ANCHOR      0x0400
#define EXT4_GET_BLOCKS_PUT_COLD_ANCHOR     0x0800
#define EXT4_GET_BLOCKS_CLEAR_ANCHOR        0x1000

#define EXT4_GET_BLOCKS_ANCHOR (EXT4_GET_BLOCKS_PUT_HOT_ANCHOR | \
								EXT4_GET_BLOCKS_PUT_COLD_ANCHOR | \
								EXT4_GET_BLOCKS_CLEAR_ANCHOR)
/*
...
#define EXT2_FLAGS_REHASHED		0x0100  /* QNAP: rehashed */
...
#define EXT4_S_ERR_END offsetof(struct ext4_super_block, s_mount_opts)
	...
	__le32  s_hash_revision;        /* QNAP Hash revision */
	__le32  s_QNAP_magic;
	union {
...
#define EXT4_MF_LAZY_INIT_STARTED	0x0010
 ...
 */
#ifdef QNAP_SEARCH_FILENAME_CASE_INSENSITIVE
#define is_qnap_sb_hash(inode) \
	(ntohl(EXT4_SB(inode->i_sb)->s_es->s_hash_magic) == QNAP_SB_HASH)

#define is_dx(dir) ((is_qnap_sb_hash(dir) || \
...
extern int qnap_ext4fs_dirhash(const char *name, int len,
			       struct dx_hash_info *hinfo,
...
extern s64 qnap_ext4_init_reserve_inode_table(struct super_block *sb,
...
extern int qnap_ext4_trim_fs_async(struct super_block *, struct fstrim_range *);
extern void qnap_ext4_destroy_trim_thread(struct ext4_sb_info *sbi);
...
#ifdef QNAP_SEARCH_FILENAME_CASE_INSENSITIVE
extern const struct dentry_operations qnap_ext4_dentry_operations;
#endif
/* symlink.c */
...
extern void ext4_io_submit_init(struct ext4_io_submit *io,
				struct writeback_control *wbc, int temper);
