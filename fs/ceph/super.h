...
struct ceph_inode_info {
	...
	struct ceph_quota_info i_quota;
};
...
extern bool is_quota_enable(struct ceph_quota_info *quota);
...
extern bool ceph_is_quota_files_exceeded(struct ceph_inode_info *ci);
extern bool ceph_is_quota_bytes_exceeded(struct ceph_inode_info *ci, s64
					 new_bytes);
...
extern int dentry_lease_is_valid(struct dentry *dentry);
extern int dir_lease_is_valid(struct inode *dir, struct dentry *dentry);
