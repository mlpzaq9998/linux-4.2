...
#define VAAI_THREAD 64
#define INQUIRY_TIMEOUT 3
#endif
...
#if defined(NFS_VAAI_V3)
__be32 nfsd_inquiry(struct svc_fh *dst_fhp, u64 *count, u32 *status);
__be32 nfsd_taskabort(struct svc_fh *dst_fhp, u32 *status);
