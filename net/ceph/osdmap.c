				      ...
				      struct ceph_osdmap *map)
{
	...
	*p = new_state;
	...
	while (len--) {
		...
		/*
		 * KH-Redmine#41932:
		 * The NOUP/NODOWN/NOIN/NOOUT flags will be masked out due to
		 * only 8-bit state is encoded.  Under such condition, the
		 * CEPH_OSD_UP will be wiped out if any update with above flag
		 * change are coming.
		 */
		//if (xorstate == 0)
