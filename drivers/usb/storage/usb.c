...
static unsigned int uas_enable = 0;
module_param(uas_enable, uint, S_IRUGO | S_IWUSR);
MODULE_PARM_DESC(uas_enable, "enable/disable uas function");
			 ...
			 const struct usb_device_id *id)
{
	...
	if (uas_use_uas_driver(intf, id, NULL)){
		if((uas_enable ==1 )|| ((uas_enable ==0) && (strstr(udev->product,"QNAP TRCT")!=NULL))){
		return -ENXIO;
		}
	}
#endif
