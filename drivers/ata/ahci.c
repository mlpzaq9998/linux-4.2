...
static const struct pci_device_id ahci_pci_tbl[] = {
	...
	{ PCI_DEVICE(PCI_VENDOR_ID_MARVELL_EXT, 0x9215),
	  .driver_data = board_mv9215 }, /* 88se9215 */
#endif
...
#ifdef CONFIG_MACH_QNAPTS
//Patch by QNAP:Marvell 9235 workaround, fix Bug#120939
...
////////////////////////////////////
...
#ifdef CONFIG_MACH_QNAPTS
	// bug#100135, turn-off port multiplier support for chip 0x8086:0x5ae3
	// bug#81112 , turn-off port multiplier support for chip 0x8086:0x0f23
	{
		if (pdev->vendor == PCI_VENDOR_ID_INTEL && pdev->device == 0x5ae3) {
			printk(KERN_ALERT "Atom\/Celeron\/Pentium Processor N4200\/N3350\/E3900 Series SATA AHCI Controller, no ATA_FLAG_PMP");
		}
		else if (pdev->vendor == PCI_VENDOR_ID_INTEL && pdev->device == 0x0f23) {
			printk(KERN_ALERT "Atom Processor E3800 Series SATA AHCI Controller, no ATA_FLAG_PMP");
		}
		else
		{
	...
	if (pdev->vendor == PCI_VENDOR_ID_MARVELL_EXT
		...
		/* MV9235 JBOD support */
		mv9235_i2c_init(pdev, hpriv->mmio);
