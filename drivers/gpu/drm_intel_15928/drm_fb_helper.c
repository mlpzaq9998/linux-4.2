					 ...
					 int preferred_bpp)
{
	...
	if (crtc_count == 0 || sizes.fb_width == -1 || sizes.fb_height == -1) {
		...
		//      [2015-11-03 by LIN_WC]: Patched for QNAP show default image (HD Station), image is 800x600 size
		//	DRM_INFO("Cannot find any crtc or sizes - going 1024x768\n");
		DRM_INFO("Cannot find any crtc or sizes - going 800x600\n");
		sizes.fb_width = sizes.surface_width = 800; //	1024;
		sizes.fb_height = sizes.surface_height = 600; //	768;
	}
