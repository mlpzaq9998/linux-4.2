 ...
 * @bus_id: A string which matches phydev->dev.bus_id (or PHY_ANY_ID) (for other)
 * @bus_id: A string which matches phydev->mdio.dev.bus_id (or PHY_ANY_ID) (for 3700 and 8k)
