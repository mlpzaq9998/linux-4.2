...
#define MVEBU_UART_TYPE		"mvebu-uart2"
#define DRIVER_NAME		"mvebu-serial2"
...
static int mvebu_uart_probe(struct platform_device *pdev)
{
	...
	data = devm_kzalloc(&pdev->dev, sizeof(struct mvebu_uart_data), GFP_KERNEL);
	if (!data)
		return -ENOMEM;
...
device_initcall(mvebu_uart_init);
