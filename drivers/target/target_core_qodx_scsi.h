...
/* TBD
 * Set to 128 MB only due to Windows expects the copy manager to complete the
 * synchronous offload read/write SCSI commands within 4 seconds.
 * value is too large to bad either file based lun or block baesd lun
 *
