...
static struct {
	...
	/* case for product added fc solution, we changed inquery reported data string,
	 * either iscsi or fc, we use Storage' string now
	 */
	{"QNAP", "Storage", NULL, BLIST_MAX_1024},
#endif
	...
	/* Bug 49044 ST900MM0002 firware bug */
