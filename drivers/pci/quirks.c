...
/*
 * QNAP patch
 * For TS-832X PCI bridge issue
 * Fix hal_app get pci configuration space size is 4096, will cause segmentation fault
 */
static void quirk_PI7C9X2G304SL(struct pci_dev *dev)
{
	dev->cfg_size = 1024;
}
DECLARE_PCI_FIXUP_HEADER(0x12d8,	0x2304,	quirk_PI7C9X2G304SL);
