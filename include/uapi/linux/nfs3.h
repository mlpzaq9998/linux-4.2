...
enum nfs3_vstorageop {
	...
	NFS3_VSTORAGEOP_INQUIRY = 4,
	NFS3_VSTORAGEOP_TASKABORT = 5
#endif
};
#if defined(NFS_VAAI)
enum vaai_cmd_status {
	VAAI_CMD_STATUS_INIT = 0,
	VAAI_CMD_STATUS_RUNNING = 1,
	VAAI_CMD_STATUS_FINISH = 2,
	VAAI_CMD_STATUS_ERROR = 3,
	VAAI_CMD_STATUS_TASKABORT = 4,
	VAAI_CMD_STATUS_END = 5
};
#endif
#endif
#endif
