 ...
 * @caps:The structure describing types and directions supported by endoint (for 4700 and 8k).
 ...
 * @otg_caps: OTG capabilities of this gadget (for 3700).
 ...
 *	be connected (for 3700).
 * @connected: True if gadget is connected (for 3700).
 *
