...
#ifdef CONFIG_MACH_QNAPTS
/* TODO: this is changed for
 * 1 - iSCT test case: Test 15.2 NOP-In Ping Requeston Timeout
 * 2 - Citrix server multipath test
 */
...
#ifdef CONFIG_MACH_QNAPTS
	ICF_OOO_CMDSN_IGNORED			= 0x40000000,
...
#ifdef CONFIG_MACH_QNAPTS
	atomic_t		conn_reinstatement_not_sleep;
#endif
...
struct iscsi_session {
	...
	__u64			login_time;
	int 			icmd_skip_inc_expcmdsn;
	/* workaround that protected by conn_lock */
	bool			sess_release;
#endif
