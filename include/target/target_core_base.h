...
#ifdef CONFIG_MACH_QNAPTS
	TRANSPORT_WORK_THREAD_PROCESS = 20,
#endif
};
...
#ifdef CONFIG_MACH_QNAPTS
	TCM_MISCOMPARE_DURING_VERIFY_OP 	= R(0x18),
	TCM_PARAMETER_LIST_LEN_ERROR		= R(0x19),
	TCM_UNREACHABLE_COPY_TARGET		= R(0x1a),
	TCM_3RD_PARTY_DEVICE_FAILURE		= R(0x1b),
	TCM_INCORRECT_COPY_TARGET_DEV_TYPE	= R(0x1c),
	TCM_TOO_MANY_TARGET_DESCRIPTORS 	= R(0x1d),
	TCM_TOO_MANY_SEGMENT_DESCRIPTORS	= R(0x1e),
	TCM_ILLEGAL_REQ_DATA_OVERRUN_COPY_TARGET	= R(0x1f),
	TCM_ILLEGAL_REQ_DATA_UNDERRUN_COPY_TARGET	= R(0x20),
	TCM_COPY_ABORT_DATA_OVERRUN_COPY_TARGET 	= R(0x21),
	TCM_COPY_ABORT_DATA_UNDERRUN_COPY_TARGET	= R(0x22),
	TCM_INSUFFICIENT_RESOURCES			= R(0x23),
	TCM_INSUFFICIENT_RESOURCES_TO_CREATE_ROD	= R(0x24),
	TCM_INSUFFICIENT_RESOURCES_TO_CREATE_ROD_TOKEN	= R(0x25),
	TCM_OPERATION_IN_PROGRESS			= R(0x26),
	TCM_INVALID_TOKEN_OP_AND_INVALID_TOKEN_LEN	= R(0x27),
	TCM_INVALID_TOKEN_OP_AND_CAUSE_NOT_REPORTABLE	= R(0x28),
	TCM_INVALID_TOKEN_OP_AND_REMOTE_ROD_TOKEN_CREATION_NOT_SUPPORTED	= R(0x29),
	TCM_INVALID_TOKEN_OP_AND_REMOTE_ROD_TOKEN_USAGE_NOT_SUPPORTED		= R(0x2a),
	TCM_INVALID_TOKEN_OP_AND_TOKEN_CANCELLED				= R(0x2b),
	TCM_INVALID_TOKEN_OP_AND_TOKEN_CORRUPT					= R(0x2c),
	TCM_INVALID_TOKEN_OP_AND_TOKEN_DELETED					= R(0x2d),
	TCM_INVALID_TOKEN_OP_AND_TOKEN_EXPIRED					= R(0x2e),
	TCM_INVALID_TOKEN_OP_AND_TOKEN_REVOKED					= R(0x2f),
	TCM_INVALID_TOKEN_OP_AND_TOKEN_UNKNOWN					= R(0x30),
	TCM_INVALID_TOKEN_OP_AND_UNSUPPORTED_TOKEN_TYPE 			= R(0x31),
	TCM_SPACE_ALLOCATION_FAILED_WRITE_PROTECT				= R(0x32),
	TCM_THIN_PROVISIONING_SOFT_THRESHOLD_REACHED				= R(0x33),
	TCM_CAPACITY_DATA_HAS_CHANGED = R(0x34),
	TCM_REPORTED_LUNS_DATA_HAS_CHANGED = R(0x35),
#endif
#undef R
};
...
#define CMD_T_BUSY		(1 << 9)
	 ...
	 * flag to indicate they will be check (aborted or not) before response
	 * them to host
	 */
...
/* for CMD_T_XXXX, please take care original design listed above */
#define CMD_T_RELEASE_CMD_FROM_CONN	(1 << 30)
#define CMD_T_QUEUED		(1 << 31)
...
#define MAX_ACL_TAG_SIZE 64
	...
	spinlock_t		acl_read_info_lock;
	spinlock_t		acl_drop_node_lock;
	atomic_t		acl_read_info;
	atomic_t		acl_drop_node;
#endif
...
#ifdef CONFIG_MACH_QNAPTS
	struct qnap_se_sess_dr	sess_dr;
#endif
...
struct se_dev_attrib {
	...
	/* following list is for dev attribute */
	int		emulate_v_sup;
	u32		lun_index;

#ifdef SUPPORT_TP
	int		tp_threshold_hit;
	u32		tp_threshold_enable;
...
#define DF_USING_BBUJOURNAL			0x00000800
#endif
