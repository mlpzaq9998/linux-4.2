...
struct target_backend_ops {
	...
	int (*change_dev_size)(struct se_device *);
	int (*set_write_cache)(struct se_device *, bool);
	int (*set_fua)(struct se_device *, bool);
	/* front-end dev*/
	struct request_queue *(*get_rq)(struct se_device *);
	void *(*get_dev)(struct se_device *);
#endif
#ifdef QNAP_SHARE_JOURNAL
	int (*set_journal_support)(struct se_device *, unsigned long);
#endif
...
#endif
	sense_reason_t (*execute_qnap_sync_cache)(struct se_cmd *cmd);
#endif
