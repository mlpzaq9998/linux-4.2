...
static void __setup_per_zone_wmarks(void)
{
	...
	for_each_zone(zone) {
		...
		/* QNAP patched, change value of low to high, value of high ...
		 * min_free_kbytes=32768
		 *     min:  512, low:  640 ->  768, high:  768 -> 1024
		 * min_free_kbytes=65536
		 *     min: 1024, low: 1280 -> 1536, high: 1536 -> 2048
		 * min_free_kbytes=131072
		 *     min: 2048, low: 2560 -> 3072, high: 3072 -> 4096
		 */
	...
	/* FIXME default value for wmark_low_kbytes, wmark_high_kbytes */
...
int wmark_min_kbytes_sysctl_handler(struct ctl_table *table, int write,
	void __user *buffer, size_t *length, loff_t *ppos)
{
	int rc;
...
int wmark_low_kbytes_sysctl_handler(struct ctl_table *table, int write,
	void __user *buffer, size_t *length, loff_t *ppos)
{
	int rc;
...
int wmark_high_kbytes_sysctl_handler(struct ctl_table *table, int write,
	void __user *buffer, size_t *length, loff_t *ppos)
{
	int rc;
