...
static bool audio_id_reverse = false;
static int audio_limit_count = 0;
module_param(static_hdmi_pcm, bool, 0644);
MODULE_PARM_DESC(static_hdmi_pcm, "Don't restrict PCM parameters per ELD info");

module_param(audio_id_reverse, bool, 0644);
MODULE_PARM_DESC(audio_id_reverse, "For TVS-X82 the audio id has to reverse");

module_param(audio_limit_count, int, 0644);
MODULE_PARM_DESC(audio_limit_count, "Limit audio count by enabled HDMI");
...
static int hdmi_add_pin(struct hda_codec *codec, hda_nid_t pin_nid)
{
	...
	if (audio_limit_count > 0)
		if (spec->num_pins >= audio_limit_count)
			return 0;
...
static int generic_hdmi_build_pcms(struct hda_codec *codec)
{
	...
	if (audio_id_reverse){
		...
		for (pin_idx = spec->num_pins-1; pin_idx >= 0; pin_idx--) {
			struct hda_pcm *info;
			struct hda_pcm_stream *pstr;

			info = snd_hda_codec_pcm_new(codec, "HDMI %d", (spec->num_pins-1)-pin_idx);
			if (!info)
				return -ENOMEM;
...
static int generic_hdmi_init_per_pins(struct hda_codec *codec)
{
	...
	for (pin_idx = 0; pin_idx < spec->num_pins; pin_idx++) {
		...
		if (audio_id_reverse)
			eld_proc_new(per_pin, (spec->num_pins-1)-pin_idx);
		else
...
static int patch_generic_hdmi(struct hda_codec *codec)
{
	 ...
	 */
	if (is_valleyview_plus(codec) || is_skylake(codec) || is_kabylake(codec))
...
{ .id = 0x10de007e, .name = "GPU 7e HDMI/DP",   .patch = patch_nvhdmi },
{ .id = 0x10de0080, .name = "GPU 80 HDMI/DP",   .patch = patch_nvhdmi },
{ .id = 0x10de0081, .name = "GPU 81 HDMI/DP",   .patch = patch_nvhdmi },
{ .id = 0x10de0082, .name = "GPU 82 HDMI/DP",   .patch = patch_nvhdmi },
{ .id = 0x10de0083, .name = "GPU 83 HDMI/DP",   .patch = patch_nvhdmi },
{ .id = 0x10de0084, .name = "GPU 84 HDMI/DP",   .patch = patch_nvhdmi },
{ .id = 0x10de0090, .name = "GPU 90 HDMI/DP",   .patch = patch_nvhdmi },
{ .id = 0x10de0091, .name = "GPU 91 HDMI/DP",   .patch = patch_nvhdmi },
{ .id = 0x10de0092, .name = "GPU 92 HDMI/DP",   .patch = patch_nvhdmi },
{ .id = 0x10de0093, .name = "GPU 93 HDMI/DP",   .patch = patch_nvhdmi },
{ .id = 0x10de0094, .name = "GPU 94 HDMI/DP",   .patch = patch_nvhdmi },
{ .id = 0x10de0095, .name = "GPU 95 HDMI/DP",   .patch = patch_nvhdmi },
{ .id = 0x10de0097, .name = "GPU 97 HDMI/DP",   .patch = patch_nvhdmi },
{ .id = 0x10de0098, .name = "GPU 98 HDMI/DP",   .patch = patch_nvhdmi },
{ .id = 0x10de0099, .name = "GPU 99 HDMI/DP",   .patch = patch_nvhdmi },
...
MODULE_ALIAS("snd-hda-codec-id:10de007e");
MODULE_ALIAS("snd-hda-codec-id:10de0080");
MODULE_ALIAS("snd-hda-codec-id:10de0081");
MODULE_ALIAS("snd-hda-codec-id:10de0082");
MODULE_ALIAS("snd-hda-codec-id:10de0083");
MODULE_ALIAS("snd-hda-codec-id:10de0084");
MODULE_ALIAS("snd-hda-codec-id:10de0090");
MODULE_ALIAS("snd-hda-codec-id:10de0091");
MODULE_ALIAS("snd-hda-codec-id:10de0092");
MODULE_ALIAS("snd-hda-codec-id:10de0093");
MODULE_ALIAS("snd-hda-codec-id:10de0094");
MODULE_ALIAS("snd-hda-codec-id:10de0095");
MODULE_ALIAS("snd-hda-codec-id:10de0097");
MODULE_ALIAS("snd-hda-codec-id:10de0098");
MODULE_ALIAS("snd-hda-codec-id:10de0099");
